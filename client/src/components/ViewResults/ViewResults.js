            ...
            <div className="view-results-wrapper">
                ...
                {(this.state.quiz && this.state.result) && 
                    <div className="body">
                        ...
                        <div className="img">
                            <img alt="description" src={this.state.quiz.imgUrl ? this.state.quiz.imgUrl : 'https://images.unsplash.com/photo-1518770660439-4636190af475?ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8dGVjaG5vbG9neXxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&w=1000&q=80'} />
                        </div>
                    </div>
                }
            </div>
