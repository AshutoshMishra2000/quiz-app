                                ...
                                <div className="img-uploader">
                                    ...
                                    <div className="upload-box">
                                        ...
                                        {this.state.previewSource ?
                                            <img className="display-image" alt="Description" src={this.state.previewSource} />
                                            : (this.state.user.avatar && this.state.user.avatar.url ? <img  alt="Description" style={{borderRadius: '50%', objectFit: 'cover', margin: '20px auto 0 25px', width: '25vw', height: '25vw'}} className="display-image" src={this.state.user.avatar.url} />  : <img className="display-image" src={this.state.previewSource}  alt="Description"/> )}
                                    </div>
